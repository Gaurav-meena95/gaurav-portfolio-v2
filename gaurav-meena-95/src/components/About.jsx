          ...
          <div className="relative bg-[#161B22]/60 backdrop-blur-xl rounded-2xl p-8 md:p-12 border border-white/10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {quickInfo.map((item, index) => (
                ...
                >
                  <div className="absolute -inset-0.5 bg-linear-to-r from-[#00A3FF] to-[#A855F7] rounded-xl opacity-0 group-hover/card:opacity-20 blur transition duration-300"></div>
